                            ...
                            <div class="accordion-body p-4">
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <input type="text" class="form-control auth-input" value="{{ $user->whatsapp_prefix ?? '' }}" disabled>
                                    </div>
                                    <div class="col-md-3">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="row g-2">
                                            <div class="col-4">
                                                <input type="text" class="form-control auth-input" value="{{ $user->birth_year ?? '' }}" disabled placeholder="السنة">
                                            </div>
                                            <div class="col-4">
                                                <input type="text" class="form-control auth-input" value="{{ $user->birth_month ?? '' }}" disabled placeholder="الشهر">
                                            </div>
                                            <div class="col-4">
                                                <input type="text" class="form-control auth-input" value="{{ $user->birth_day ?? '' }}" disabled placeholder="اليوم">
                                            </div>
                                        </div>
                                    </div>
                                    @if($user->id_image)
                                    <div class="col-12">
                                        ...
                                        <div>
                                            <img src="{{ asset('storage/'.$user->id_image) }}" alt="صورة الهوية" class="img-thumbnail" style="max-width: 300px; max-height: 300px;" onerror="this.style.display='none'">
                                        </div>
                                    </div>
                                    @endif
                                </div>
